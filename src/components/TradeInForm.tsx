...
export default function TradeInForm() {
  ...
  const loadMyRequests = async () => {
    try {
      ...
      // Pegar token do localStorage (pode estar em 'token' ou dentro do objeto 'user')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('❌ Trade-in error:', errorData);
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('✅ Imagens enviadas:', newImageUrls);
      } else {
  ...
  const statusConfig: Record<string, { label: string; color: string }> = {
    ...
    open: { label: 'Em Análise', color: 'bg-blue-500' },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Troque seu dispositivo usado por crédito. Avaliação gratuita e processo rápido!
          </p>
        </div>
            ...
            <CardHeader className="border-b">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Histórico e status das suas trocas</CardDescription>
                </div>
                <Button
            ...
            <CardContent className="pt-6">
              {loadingRequests ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">Comece criando sua primeira solicitação de trade-in</p>
                  <Button 
            ...
            <Card>
              <CardHeader className="border-b">
                <CardTitle className="text-xl flex items-center gap-2">
                  ...
                  Nova Solicitação Trade-In
                </CardTitle>
                <CardDescription>Preencha as informações do dispositivo</CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg space-y-4">
              ...
              <div>
                ...
                <Select value={deviceType} onValueChange={setDeviceType}>
                  ...
                  <SelectContent>
                    <SelectItem value="phone">📱 Telemóvel</SelectItem>
              ...
              <div>
                <label className="text-sm font-medium mb-2 block text-gray-700">Condição do Dispositivo *</label>
                <Select value={condition} onValueChange={setCondition}>
                  <SelectTrigger className="bg-white">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Bom (pequenos sinais de uso)">✨ Bom - Sinais leves de uso (80% do valor)</SelectItem>
                    <SelectItem value="Razoável">⚠️ Razoável - Arranhões visíveis (50% do valor)</SelectItem>
                    <SelectItem value="Com defeito">🔧 Com defeito - Precisa reparos (20% do valor)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                <label className="text-sm font-medium mb-2 block text-gray-700">Descrição do Estado</label>
                <textarea 
                  value={description}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Adicione fotos do dispositivo para uma avaliação mais precisa
                </p>
              </div>
            </div>
            ...
            <CardContent className="pt-8">
              <div className="text-center py-6">
                ...
                <p className="text-gray-600 mb-6">
                  Nossa equipe irá avaliar seu dispositivo e entrar em contato em breve
                </p>
                ...
                {estimatedValue && estimatedValue > 0 && (
                  <div className="max-w-md mx-auto p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl mb-6">
                    <p className="text-sm font-medium text-gray-700 mb-2">💰 Valor Estimado</p>
                    <p className="text-4xl font-bold text-green-600 mb-1">
                      {estimatedValue.toLocaleString('pt-AO')} Kz
                    </p>
                    <p className="text-xs text-gray-600 mt-3">
                      *Valor final sujeito a avaliação física do dispositivo
                    </p>
                  </div>
                )}
