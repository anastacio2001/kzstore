...
import { ArrowLeft, User, Mail, Phone, MapPin, Lock, Save, Eye, EyeOff, CheckCircle, AlertCircle, Award } from 'lucide-react';
      ...
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex items-center gap-4">
            <div className="size-16 rounded-full bg-gradient-to-br from-red-600 to-red-700 flex items-center justify-center text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl border mb-6 overflow-hidden">
          <div className="flex border-b">
            ...
            >
              <User className="size-5 inline mr-2" />
              Dados Pessoais
            </button>
            <button
            ...
            >
              <Award className="size-5 inline mr-2" />
              Fidelidade
            </button>
          </div>
            ...
            <form onSubmit={handleSaveProfile} className="p-6 space-y-6">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-900 font-semibold">Informação Importante</p>
                    <p className="text-sm text-blue-700 mt-1">
                      Estes dados serão usados automaticamente nos seus próximos pedidos para agilizar o checkout.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 rounded-xl border-2 ${
                      profileErrors.nome ? 'border-red-300' : 'border-gray-200'
                    } focus:border-red-600 focus:outline-none transition-all`}
                    placeholder="João Silva"
                  />
                </div>
                {profileErrors.nome && (
                  <p className="mt-2 text-sm text-red-600">{profileErrors.nome}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled
                    className="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-gray-200 bg-gray-50 text-gray-500 cursor-not-allowed"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 rounded-xl border-2 ${
                      profileErrors.telefone ? 'border-red-300' : 'border-gray-200'
                    } focus:border-red-600 focus:outline-none transition-all`}
                    placeholder="+244 900 000 000"
                  />
                </div>
                {profileErrors.telefone && (
                  <p className="mt-2 text-sm text-red-600">{profileErrors.telefone}</p>
                )}
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500">
                  Este endereço será usado por padrão nos seus pedidos
                </p>
              </div>
              ...
              <Button
                type="submit"
                disabled={isSaving}
                className="w-full bg-red-600 hover:bg-red-700 text-white py-3.5 rounded-xl font-semibold"
              >
                {isSaving ? (
                  <>
            ...
            <form onSubmit={handleChangePassword} className="p-6 space-y-6">
              <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-yellow-900 font-semibold">Segurança da Conta</p>
                    <p className="text-sm text-yellow-700 mt-1">
                      Use uma senha forte com no mínimo 6 caracteres para proteger sua conta.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <CheckCircle className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400" />
                  <input
                    type="password"
          ...
          {/* Loyalty Tab */}
          {activeTab === 'loyalty' && user?.access_token && (
            <div className="p-6">
              <LoyaltyProgram
