...
# Script para criar tabela abandoned_carts via gcloud sql

echo "📦 Criando tabela abandoned_carts no Cloud SQL..."

gcloud sql connect kzstore-01 --user=root --project=kzstore-477422 <<'EOSQL'
USE kzstore_prod;
